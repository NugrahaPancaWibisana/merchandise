    ...
    <main class="w-full h-screen pl-[280px]">
        <section class="p-10">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-zinc-800">Tambah Produk</h1>
            </div>

            <form action="{{ route('admin.products.create') }}" method="POST" class="mt-10 bg-zinc-100 p-6 rounded-lg shadow-md">
                @csrf
